...
> [!IMPORTANT]
> For Azure Synapse Analytics, currently DNS alias is only supported for Dedicated SQL Pool (Formerly DW). Synapse Dedicated SQL Pool is not supported at this time.
